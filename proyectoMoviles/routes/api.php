...
Route::post('/delete_company/{id}', [CompanyController::class, 'destroy']);//done
Route::put('/update_company/{id}', [CompanyController::class, 'update']);//done
...
Route::put('/update_usuario/{id}', [UsuarioController::class, 'update']);//done
