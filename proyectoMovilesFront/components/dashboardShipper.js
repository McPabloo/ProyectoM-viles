...
export default function Shipper({navigation}) {
  ...
  const getShipper = async () => {
    const res = await axios.get("http://192.168.204.142:8000/api/cargador_index")
  ...
  const eliminar=async(e)=>{
    ...
    const formDatum = new FormData();
        ...
        const res = await axios.post("http://192.168.204.142:8000/api/delete_cargador", formDatum,
        {
            headers: {
