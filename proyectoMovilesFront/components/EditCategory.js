...
export default function CategoryE({ navigation }) {
    ...
    const getCategory = async () => {
        const res = await axios.get(`http://192.168.204.142:8000/api/show_category/${categoryID}`);
    ...
    const send_request = async () => {
        ...
        const res1 = await axios.post('http://192.168.204.142:8000/api/update_category', formDatum,
            {
                headers: {
