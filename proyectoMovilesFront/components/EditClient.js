...
export default function ClientE({ navigation }) {
    ...
    const getClient = async () => {
        const res = await axios.get(`http://192.168.1.78:8000/api/show_cliente/${clientID}`);
    ...
    const send_request = async () => {
        ...
        const res1 = await axios.post('http://192.168.1.78:8000/api/update_cliente', formDatum,
            {
                headers: {
