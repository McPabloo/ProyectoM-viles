...
export default function Users({navigation}) {
  ...
  const getUser = async () => {
    const res = await axios.get("http://192.168.204.142:8000/api/usuario_index")
  ...
  const eliminar=async(e)=>{
    ...
    const formDatum = new FormData();
        ...
        const res = await axios.post("http://192.168.204.142:8000/api/delete_usuario", formDatum,
        {
            headers: {
