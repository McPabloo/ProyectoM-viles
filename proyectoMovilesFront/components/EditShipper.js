...
export default function ShipperE({navigation}) {
  ...
  const getShipper = async () => {
    const res = await axios.get(`http://192.168.1.70:8000/api/show_cargador/${shipperID}`);
  ...
  const send_request=async()=>{
        ...
        const res1 = await axios.post('http://192.168.1.70:8000/api/update_cargador',formDatum,
        {
            headers: {
