...
export default function UserE({navigation}) {
  ...
  const getUser = async () => {
    const res = await axios.get(`http://192.168.100.26:8000/api/show_usuario/${userID}`);
  ...
  const send_request=async()=>{
        ...
        const res1 = await axios.post('http://192.168.100.26:8000/api/update_usuario',formDatum,
        {
            headers: {
